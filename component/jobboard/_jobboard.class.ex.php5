...
class CJobboardEx extends CJobboard
{
  ...
  */
  public function getJobApplyForm($pnPk)
  {
   if(!assert('is_integer($pnPk)'))
    ...
    $oForm->addField('textarea', 'coverletter', array('label'=>$this->casText['TALENT_YOUR_LETTER'], 'value' => '','style'=>'width:450px;height:250px;'));
  ...
  */
  private function _getResumeSave($pnPositionPk)
  {
    ...
    $ncanContact = getValue('accept_contact', 0);
    ...
    else
    {
      ...
      $sContent.= '<br />';
      $sContent.= 'A member of our team will contact you shortly to .<br/>';
      $sContent.= 'Best regards.';
    }
