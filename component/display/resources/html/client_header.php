      ...
      <td align="center">
        <table  align="center">
		    <tr>
		      ...
		      <td>
		      <td class='topMenuText'>
		      	<img style="text-align: center; height: 25px; margin-left:10px; margin-right:5px;" src="/common/pictures/add_48.png" />
		      	<a style='margin-right:10px;font-size: 15px;'>Add </a>
		      	<img style="text-align: center; margin-left:10px; margin-right:5px;" src="/common/pictures/divider.png" />
		      <td>
		      <td  class='topMenuText'>
		      	<img  style="text-align: center; height: 25px; margin-left:10px; margin-right:5px;" src="/common/pictures/stat_48.png" />
		      	<a style='margin-right:10px;font-size: 15px;'>Reports </a>
		      	<img style="text-align: center; margin-left:10px; margin-right:5px;" src="/common/pictures/divider.png" />
		      <td>
		      <td  class='topMenuText'>
		      	<img  style="text-align: center; height: 25px; margin-left:10px;" src="/common/pictures/tool_48.png" />
