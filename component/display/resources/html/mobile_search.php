...
<html >
  ...
  <body>
    ...
    <form action='https://jobs.slate.co.jp/index.php5?uid=153-160&ppa=ppal&ppt=job&ppk=0&pg=ajx' method='post'>
       <table bgcolor="white" style='width:100%; background: url("http://jobs.slate.co.jp/component/display/resources/jobboard/pictures/bg_s.png") no-repeat center scroll ;'>
        <tr>
          <td >
            ...
            <a href="" >
              <img align="right" style='width: 100px; margin-right:50px;' src="http://jobs.slate.co.jp/component/display/resources/jobboard/pictures/japan.png" title="日本語">
            </a>
            <a href="" >
