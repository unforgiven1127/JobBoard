        ...
        foreach($positions as $key => $value)
        {
            ...
            echo "<tr id='".$i."_move' class='border_bottom' style='width:90% !important; ".$color." '>
                    <td style='padding-left:5%; padding-right:5%; width:90% !important;'>
                      <b><li style='list-style-position: outside; font-size: 10pt; margin-top: 1em; margin-bottom: 0em;'>".$value['position_title']."</li></b>
                      <b><li style='list-style-position: outside; font-size: 10pt; margin-top: 3px; margin-bottom: 0em;'>".$value['location']."</li></b>
                      <b><li style='list-style-position: outside; font-size: 10pt; margin-top: 3px; margin-bottom: 0em;'>".$value['name']."</li></b>
