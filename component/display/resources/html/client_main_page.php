    ...
    <tr>
      <td valign="top">
        ...
        <table class='leftSideTable'>
          ...
          <tr>
            <td>
              <select style='height:20px !important; margin-left: 5px !important; margin-bottom: 5px !important; margin-top: 10px !important; margin-bottom: 10px !important; width: 190px !important; border:1px solid #808080;' name="webmenu" id="webmenu">
