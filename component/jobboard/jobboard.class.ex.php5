  ...
  private function _getJobRow($pasJobData, $psCompact=false)
  {
    ...
    $sHTML.= $oHTML->getBlocStart('',array('class'=>'view_content'));
      ...
      if($pasJobData['display_salary'] == 1)
      {
        ...
        else if(!empty($pasJobData['salary_high']) || $pasJobData['salary_high'] != 0)
        {
          $salaryRange = " Salary: <i style='font-weight: lighter;'>".'< &yen;'.$pasJobData['salary_high']."</i>";
        }
        else
        {
          $salaryRange = '';
...
//exit;
      ...
      $sHTML.= $oHTML->getBlocStart('',array('class'=>'position_desc','style'=>'margin-top:-6px;'));
...
*/
    ...
    */
    ...
    $oForm->addField('input', 'id_search', array('label' => 'Id'));
  ...
  */
  ...
  public function getJobList($psQueryFilter = '')
  {
    ...
    if($myIP == '209.145.97.66' || preg_match('/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i',$useragent)||preg_match('/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i',substr($useragent,0,4)))
    {
      ...
      {
        $sURL =  $oPage->getUrl($this->_getUid(), CONST_ACTION_APPLY, CONST_TA_TYPE_JOB, $value['positionpk']);
        $positions[$key]['applyUrl'] = $sURL;
      }
  ...
  */
  private function _getJobSearchSection($psSearchId, $pbSearchFormOpen)
  {
    ...
    $sHTML = $oHTML->getBlocStart('',array('class'=>'jobSearchContainer '.$sClass));
      ...
      $sHTML.= $oHTML->getBlocStart('',array('class'=>'quickSearch jobSearchContainerFolded','style'=>'display: none;'));
        ...
        $sHTML.= $oHTML->getBlocStart('',array('class'=>'newSearchDiv '));
          ...
          $sHTML.= $oHTML->getLink($this->casText['TALENT_OPEN_SEARCH'].' '.$sPicture, 'javascript:;',
            array('onclick'=> ' $(\'.detailedSearch\').toggle(); $(\'.quickSearch\').toggle();'
              , 'style' => 'color: #555; line-height: 20px; position: relative; padding-right: 25px; display: block;'));
          $sHTML.= $oHTML->getBlocEnd();
  ...
  private function _getJobDetailInformationSlistemDB($pnPk)
  {
    ...
    if(isset($positionData) && $positionData != null)
    {
      ...
      $sURL =  "'".$oPage->getUrl($this->_getUid(), CONST_ACTION_APPLY, CONST_TA_TYPE_JOB, $pnPk)."'";
        ...
        $sHTML.= "<input style='width:150px;' type='button' name='back' id='back' value='".$this->casText['TALENT_RETURN_SEARCH']."' onclick = \"document.location.href = ".$backURL."\">";
        $sHTML.= $oHTML->getBlocEnd();
        $sHTML.= $oHTML->getBlocStart('',array('class'=>'floatHack'));
        $sHTML.= $oHTML->getBlocEnd();
      $sHTML.= $oHTML->getBlocEnd();
  ...
  */
  ...
  private function _getRssFeed()
  {
    ...
    $sQuery = "SELECT slp.sl_positionpk as positionpk, slp.sl_positionpk as jobfk, slpd.is_public as visibility, slpd.category as category
            ...
            , slp.date_created as posted_date, sll.location as location, slpd.job_type as job_type, CONCAT(slp.salary_from,' - ',slp.salary_to) as salary
            , slp.salary_from as salary_low, slp.salary_to as salary_high,  CONCAT(slp.age_from,' - ',slp.age_to) as age
            , slp.lvl_japanese as japanese, slp.lvl_english as english, ind.sl_industrypk as industryfk, slpd.holidays as holidays, slpd.station as station
            , slpd.work_hours as work_hours, slpd.language as lang, ind.sl_industrypk as temp_industry, slpd.title as page_title, slpd.description as meta_desc
            , slpd.company_label as company_label, slpd.to_jobboard as to_jobboard,slp.sl_positionpk as external_key, slpd.expiration_date as expiration_date
            , ind.label as name, ind.label as parent_industry
            FROM sl_position slp
            INNER JOIN sl_position_detail slpd on slpd.positionfk = slp.sl_positionpk
            INNER JOIN sl_location sll on sll.sl_locationpk = slpd.location
            INNER JOIN sl_industry ind on ind.sl_industrypk = slp.industryfk
...
//***************CLIENT SIDE****************************
  ...
  public function clientLogin()
  {
    ...
    if($username == 'munir' && $password == '123456')// login control
    {
      ...
      $data['suggestedCandidates'] = $this->_getAllCandidates();
...
//*******************MODAL****************************
  ...
  private function _getCandidateInfo($candidate_id)
  {
    $slistemDB = CDependency::getComponentByName('database');
    $sNow = date('Y-m-d H:i:s');

    $slistemQuery = "SELECT slc.*,slcp.*,sc.name as company_name,
    ...
    ChromePhp::log($slistemQuery);
    $candidateInformation = $slistemDB->slistemGetAllData($slistemQuery);

    return $candidateInformation;
  }

  private function _getAllCandidates()
  {
    $oPage = CDependency::getComponentByName('page');
    $slistemDB = CDependency::getComponentByName('database');
