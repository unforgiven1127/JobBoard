...
(function($) {
	...
	$.anythingSlider.defaults = {
		...
		startText           : "<img src='media/picture/play.png' width='30' height='30'>",   // Start button text
		stopText            : "<img src='media/picture/pause.png' width='30' height='30'>",    // Stop button text
