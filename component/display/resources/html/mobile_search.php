        ...
        foreach($positions as $key => $value)
        {
            ...
            echo "<tr class='border_bottom' style='width:90% !important; ".$color." '>
                    <td style='padding-left:5%; padding-right:5%; width:90% !important;'>
                      <b><p style='font-size: 26pt;'>".$value['position_title']."</p></b>
                      <b><p style='font-size: 26pt;'>".$value['location']."</p></b>
                      <b><p style='font-size: 26pt;'>".$value['name']."</p></b>
                      <p style='font-size: 26pt;'>".$value['name']."</p>
                    </td>
                  </tr>";
        } ?>
       </table></center>
