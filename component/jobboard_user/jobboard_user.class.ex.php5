    ...
    $sHTML = "
          ...
          <tr style='width:100%; class='list_row' >
            <th style='color:white; width:10%; font-size:11pt;' >
              <i style='color:white;' class='fa fa-sort-numeric-desc fa-2x' aria-hidden='true'></i>&nbsp;
              Position ID&nbsp;
              <i style='color:white;' class='fa fa-sort-numeric-asc fa-2x' aria-hidden='true'></i></th>
