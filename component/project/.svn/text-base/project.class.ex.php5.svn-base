  ...
  */
  ...
  private function _getTaskList($pbMyTask = true, $pbManagingTask = false)
  {
    ...
    if(empty($sOrder) || $sOrder == 'date')
    {
     ...
     $asTabs = array();
     $asTabs[] = array('tabtitle' => 'My todo list','tabOptions'=>array('tabId'=>'','class'=>'tab_display tab_selected'),'content' => $this->_getTasks(true, false),'contentOptions'=>array('contentId'=>'taskListMyId','class'=>'display_tab projectContainer','style'=>'display:block;'));
     $asTabs[] = array('tabtitle' => 'Tasks I\'m following','tabOptions'=>array('tabId'=>'','class'=>'tab_display'),'content' => $this->_getTasks(false, true),'contentOptions'=>array('contentId'=>'taskListOtherId','class'=>'display_tab hidden projectContainer','style'=>'display:none;'));
