          ...
          <b>ポジションの詳細を編集します。</b>
            <table>
              ...
              <tr>
                ...
                <td style='padding-top:10px;'><textarea style='font-size:12px; width:500px; border: 1px solid grey;' class='form-control' rows='4' name='metaKey_jp' id='metaKey_jp'>".$positionData['metaKey_jp']."</textarea></td>
              </tr>
            </table>
          </td>
        </tr>
